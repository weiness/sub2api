export default {
  ...
  payment: {
    ...
    quickAmounts: '快捷金额',
    customAmount: '自定义金额',
    selectPaymentAmount: '选择充值金额',
    customPaymentAmount: '自定义金额',
    currentRechargeRate: '汇率说明：1 {currency} = ${usd} 额度',
    creditUnit: '额度',
    minimumRecharge: '最低充值 {amount}',
    enterAmount: '请输入金额',
    belowMinimum: '不能低于最低充值 {amount}',
    paymentMethod: '支付方式',
    methodSecureHint: '安全快捷，推荐使用',
    fee: '手续费',
    actualPay: '实付金额',
    createOrder: '确认支付',
    submitOrder: '提交订单',
    ...
    qr: {
      ...
      orderSubmitted: '订单已提交，请扫码支付',
      orderSubmittedHint: '请在下方时间内完成支付，超时订单将自动取消',
      openPaymentApp: '打开{app}',
      tapScan: '点击「扫一扫」',
      scanQRCode: '扫描二维码',
      completePayment: '完成支付',
      scan: '扫一扫',
      completeSoon: '请尽快完成支付',
      keepPageOpen: '支付完成前请不要关闭当前页面',
      subscriptionAutoActive: '支付成功后，套餐将自动生效',
      creditAutoAdded: '支付成功后，额度将自动充值到您的账户',
    },
    orders: {
      title: '我的订单',
      empty: '暂无订单',
    ...
    creditExplanationTitle: '额度说明',
    creditExplanationSeparation: '充值余额与订阅额度分别核算，互不抵扣。',
    creditExplanationUsage: '充值余额用于按量消费，永久有效；订阅额度仅限订阅周期内使用。两类额度对应的可用分组也相互独立。',
    activeSubscription: '我的订阅',
    noActiveSubscription: '暂无有效订阅',
    tabTopUp: '充值余额',
    tabTopUpOffer: '{multiplier} 倍到账',
    tabSubscribe: '订阅套餐',
    tabSubscribeOffer: '最高省 {percent}%',
    noPlans: '暂无可用订阅套餐',
    ...
    confirmOrder: '确认订单',
    confirmBalanceOrder: '确认订单（余额充值）',
    confirmSubscriptionOrder: '确认订单（套餐订阅）',
    confirmOrderHint: '请核对订单信息并完成支付',
    selectAmountStep: '选择金额',
    selectPlanStep: '选择套餐',
    paymentResultStep: '支付结果',
    currentRate: '当前汇率',
    warmTip: '温馨提示',
    rechargeConfirmTip: '充值额度即时到账，可用于按量调用模型，永久有效，无使用期限。',
    securePaymentTitle: '安全加密支付',
    securePaymentDesc: '资金安全有保障',
    cancelPayment: '取消支付',
    securePayment: '安全加密支付，保障您的资金安全',
    permanentBalance: '余额永久有效',
    permanentBalanceDesc: '不过期，随用随充',
    usageBasedBilling: '按实际使用收费',
    usageBasedBillingDesc: '使用多少扣多少，透明计费',
    rechargeAnytime: '支持随时充值',
    rechargeAnytimeDesc: '满足你的使用需求',
    selectPlanHint: '选择适合你的套餐，支付后立即生效',
    expectedExpiry: '预计到期时间',
	...
	admin: {
      ...
      originalPrice: '原价',
      price: '价格',
      customerPriceCny: '用户实付价格（CNY）',
      customerOriginalPriceCny: '用户实付原价（CNY）',
      customerPaidPrice: '实付',
      billingPrice: '计费',
      currency: '币种标注',
      currencyPlaceholder: '如 USD / NZD / CNY',
      currencyHint: '仅用于价格展示的 ISO 三字母币种码，留空不展示，不影响实际扣款',
      subscriptionBillingPreview: '用户实付：{paid}；入库计费价格：{billing}',
      subscriptionBillingPreviewWithFee: '（含 {feeRate}% 手续费，通道合计实扣：{total}）',
      subscriptionBillingDisabled: '订阅计费倍率未启用，当前按 price 原值直接保存和收款。',
      validity: '有效期',
      validityUnit: '有效期单位',
      sortOrder: '排序',
      baseSoldCount: '基础销量',
      baseSoldCountHint: '展示销量会在实际销量和手动分配数量上加上此数值，留空默认为 0',
      forSale: '上架状态',
      recommended: '推荐',
      onSale: '上架',
      offSale: '下架',
