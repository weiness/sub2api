    ...
    settings: {
      ...
      features: {
        ...
        availableChannels: {
          ...
          channelStatusEnabled: 'Enable Channel Status',
          channelStatusEnabledHint: 'When off, the user sidebar entry is hidden and the endpoint returns an empty array.',
        },
        modelPlaza: {
          title: 'Model Plaza',
          description: 'A public page showcasing available models and pricing by group. Disabled by default.',
          enabled: 'Enable Model Plaza',
          enabledHint: 'When enabled, an entry appears in the personal menu and the page is reachable at /model-plaza.',
          requireAuth: 'Require sign-in to access',
          requireAuthHint: 'When on, anonymous visitors are redirected to sign in; when off, the model catalog is public but groups and multipliers still require sign-in.',
      ...
      payment: {
        ...
        subscriptionCnyToUsdMultiplier: 'Subscription Billing Multiplier',
        subscriptionCnyToUsdMultiplierHint:
          'For CNY payment channels, the USD billing price represented by each 1 CNY paid. Enter the customer-paid CNY amount on the plan form; the system stores its USD billing value and uses that value for affiliate rebates.',
        subscriptionCnyToUsdMultiplierDisabled: 'Disabled (price charged as-is)',
        subscriptionCnyToUsdMultiplierPreview: 'Preview: 1 CNY = {usd} USD billing price',
        subscriptionCnyToUsdMultiplierExample: 'Customer pays ¥10.00; stored billing price is ${billing}',
