export default {
  ...
  payment: {
    ...
    selectPaymentAmount: 'Select top-up amount',
    customPaymentAmount: 'Custom amount',
    currentRechargeRate: 'Rate: 1 {currency} = ${usd} credit',
    creditUnit: 'credit',
    minimumRecharge: 'Minimum {amount}',
    enterAmount: 'Enter amount',
    belowMinimum: 'Cannot be lower than the minimum {amount}',
    paymentMethod: 'Payment Method',
    methodSecureHint: 'Secure, fast, and recommended',
    fee: 'Fee',
    ...
    qr: {
      ...
      orderSubmitted: 'Order submitted, scan to pay',
      orderSubmittedHint: 'Complete payment before the timer expires or the order will be cancelled',
      openPaymentApp: 'Open {app}',
      tapScan: 'Tap Scan',
      scanQRCode: 'Scan QR code',
      completePayment: 'Complete payment',
      scan: 'Scan',
      completeSoon: 'Please complete payment soon',
      keepPageOpen: 'Keep this page open until payment is complete',
      subscriptionAutoActive: 'Your plan activates automatically after payment',
      creditAutoAdded: 'Credits are added automatically after payment',
    },
    orders: {
      title: 'My Orders',
      empty: 'No orders yet',
    ...
    creditExplanationTitle: 'About Credits',
    creditExplanationSeparation: 'Top-up balance and subscription credits are calculated separately and cannot offset each other.',
    creditExplanationUsage: 'Top-up balance is used for metered usage and never expires, while subscription credits are valid only during the subscription period. The service groups available to each are also independent.',
    activeSubscription: 'My Subscriptions',
    noActiveSubscription: 'No active subscription',
    tabTopUp: 'Top Up Balance',
    tabTopUpOffer: '{multiplier}x credits',
    tabSubscribe: 'Subscription Plans',
    tabSubscribeOffer: 'Save up to {percent}%',
    ...
    confirmBalanceOrder: 'Confirm Order (Balance Top-Up)',
    confirmSubscriptionOrder: 'Confirm Order (Subscription)',
    confirmOrderHint: 'Review your order information and complete payment',
    selectAmountStep: 'Select Amount',
    selectPlanStep: 'Select Plan',
    paymentResultStep: 'Payment Result',
    currentRate: 'Current Rate',
    warmTip: 'Please Note',
    rechargeConfirmTip: 'Credits are added immediately, never expire, and can be used for metered model calls.',
    securePaymentTitle: 'Secure encrypted payment',
    securePaymentDesc: 'Your funds are protected',
    cancelPayment: 'Cancel Payment',
    securePayment: 'Encrypted payment protects your funds',
    permanentBalance: 'Balance never expires',
    permanentBalanceDesc: 'Top up anytime and use without expiry',
    usageBasedBilling: 'Pay only for actual usage',
    usageBasedBillingDesc: 'Transparent billing based on actual usage',
    rechargeAnytime: 'Top up anytime',
    rechargeAnytimeDesc: 'Add credit whenever you need it',
    selectPlanHint: 'Choose a plan and activate it immediately after payment',
	...
	admin: {
      ...
      price: 'Price',
      customerPriceCny: 'Customer-paid Price (CNY)',
      customerOriginalPriceCny: 'Customer-paid Original Price (CNY)',
      customerPaidPrice: 'Customer pays',
      ...
      subscriptionBillingPreview: 'Customer pays: {paid}; stored billing price: {billing}',
      subscriptionBillingPreviewWithFee: '({feeRate}% fee included; gateway total: {total})',
      subscriptionBillingDisabled: 'The subscription billing multiplier is disabled; price is stored and charged as-is.',
      validity: 'Validity',
      validityUnit: 'Validity Unit',
      sortOrder: 'Sort Order',
      baseSoldCount: 'Base Sold Count',
      baseSoldCountHint: 'Added to completed sales and manual assignments for display; defaults to 0 when empty',
      forSale: 'For Sale',
