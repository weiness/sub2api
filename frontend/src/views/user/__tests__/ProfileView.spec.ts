...
describe('ProfileView', () => {
  ...
  it('renders the simplified single-column profile shell without separate stat cards', async () => {
    const wrapper = mount(ProfileView, {
      global: {
        stubs: {
          ...
          ProfilePhoneBindingCard: { template: '<div data-testid="profile-phone-binding-card" />' },
    ...
    expect(wrapper.get('[data-testid="profile-shell"]').html()).toContain('profile-phone-binding-card')
