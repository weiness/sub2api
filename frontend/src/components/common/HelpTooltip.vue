  ...
  >
    ...
    <Teleport to="body">
      <div
        ...
        role="tooltip"
        :class="[
          'fixed z-[100000100] -translate-x-1/2 -translate-y-full rounded-lg bg-gray-900 p-3 text-xs leading-relaxed text-white shadow-xl ring-1 ring-white/10 dark:bg-gray-800',
          props.widthClass,
        ]"
