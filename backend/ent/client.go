...
func (c *Client) Use(hooks ...Hook) {
	for _, n := range []interface{ Use(...Hook) }{
		...
		c.CompositeModelRoute, c.ErrorPassthroughRule, c.FAQ, c.Group,
...
// UpdateOneID returns an update builder for the given id.
func (c *FAQClient) UpdateOneID(id int64) *FAQUpdateOne {
...
// DeleteOneID returns a builder for deleting the given entity by its id.
func (c *FAQClient) DeleteOneID(id int64) *FAQDeleteOne {
...
func (c *FAQClient) Get(ctx context.Context, id int64) (*FAQ, error) {
	return c.Query().Where(faq.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *FAQClient) GetX(ctx context.Context, id int64) *FAQ {
	obj, err := c.Get(ctx, id)
	if err != nil {
		panic(err)
	}
...
type (
	hooks struct {
		...
		ChannelMonitorRequestTemplate, CompositeModelRoute, ErrorPassthroughRule, FAQ,
