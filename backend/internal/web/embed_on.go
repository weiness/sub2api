...
func (s *FrontendServer) serveIndexHTML(c *gin.Context) {
	// The entrypoint contains a per-request CSP nonce, so it must never be
	// reused through a browser cache or a conditional 304 response. Hashed
	// assets referenced by this HTML retain their long-lived immutable cache.
