...
func (s *SettingService) InitializeDefaultSettings(ctx context.Context) error {
	...
	defaults := map[string]string{
		...
		SettingKeyRegistrationVerificationType:              RegistrationVerificationEmail,
		...
		SettingKeyBotProtectionEnabled:                      "false",
		SettingKeyBotProtectionProvider:                     BotProtectionTurnstile,
		SettingKeyGraphicalCaptchaType:                      "slide",
		SettingKeySMSCodeTTLMinutes:                         "15",
		SettingKeySMSResendCooldownSeconds:                  "60",
		SettingKeySMSDailyLimit:                             "5",
		SettingKeySMSMaxVerifyAttempts:                      "5",
		SettingKeySMSChannels:                               "[]",
...
func (s *SettingService) parseSettings(settings map[string]string) *SystemSettings {
	...
	result := &SystemSettings{
		...
		SMSCodeTTLMinutes:                positiveIntOrDefault(settings[SettingKeySMSCodeTTLMinutes], 15),
		SMSResendCooldownSeconds:         positiveIntOrDefault(settings[SettingKeySMSResendCooldownSeconds], 60),
		SMSDailyLimit:                    positiveIntOrDefault(settings[SettingKeySMSDailyLimit], 5),
		SMSMaxVerifyAttempts:             positiveIntOrDefault(settings[SettingKeySMSMaxVerifyAttempts], 5),
		SMSChannels:                      parseSMSChannels(settings[SettingKeySMSChannels]),
	...
	result.ChannelStatusEnabled = settings[SettingKeyChannelStatusEnabled] == "true"
